...
/**
 * Args for the Operation ArgsGadrCreateTransWaitPadr<br> 
...
/*
  $gadrcreatetranswaitpadr (paddr_t phys_addr, plen_t
  phys_len, action_t action := action_wait, bool melt := TRUE)
  => (success_t success, len_t log_len)
*/
public class ArgsGadrCreateTransWaitPadr extends Args {
	public ArgsGadrCreateTransWaitPadr(Paddr_t phys_addr, Plen_t phys_len, int action, boolean melt){
