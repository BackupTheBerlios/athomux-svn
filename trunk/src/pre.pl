...
# static ops
  "transfer" => ["log_addr,log_len,phys_addr,direction,prio:=prio_normal", "success,phys_len", "name,conn1,conn2"],
...
# combinations
  "tr"       => ["log_addr,log_len,phys_addr,direction,prio:=prio_normal", "success,phys_len", "action"],
  "gettr"    => ["log_addr,log_len,forwrite:=FALSE,prio:=prio_normal", "success,phys_addr,phys_len", "direction,action,version"],
  "trput"    => ["log_addr,log_len,phys_addr,prio:=prio_normal", "success", "direction,action"],
