...
#define NA85E2C_CACHE_BTSC_ICM	0x0001 /* icache enable */
/* DCM0,DCM1:
     0,1: write-through
     1,0: write-back non-allocate
     1,1: write-back allocate */
#define NA85E2C_CACHE_BTSC_DCM0	0x0004 /* dcache enable, bit 0 */
#define NA85E2C_CACHE_BTSC_DCM1	0x0008 /* dcache enable, bit 1 */
#define NA85E2C_CACHE_BTSC_ISEQ	0x0010 /* icache `address sequence mode' */
#define NA85E2C_CACHE_BTSC_DSEQ	0x0020 /* dcache `address sequence mode' */
#define NA85E2C_CACHE_BTSC_IRFC	0x0030
#define NA85E2C_CACHE_BTSC_ILCD	0x4000
#define NA85E2C_CACHE_BTSC_VABE	0x8000
